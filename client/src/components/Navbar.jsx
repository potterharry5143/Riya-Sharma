...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="glass flex items-center justify-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 rounded-full pointer-events-auto max-w-[95vw]">
          ...
          return (
            <Link key={to} to={to}>
              <motion.span
                ...
                whileTap={{ scale: 0.95 }}
                className={`
                  px-2.5 sm:px-4 py-1.5 rounded-full text-xs sm:text-sm font-bold transition-colors duration-200 block whitespace-nowrap
                  ${active
